    ...
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Album != null ? 
                          ...
                          Problem("Entity set 'MusicStoreContext.Album'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("AlbumId,GenreId,ArtistId,Title,Song,Price,AlbumArtUrl")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumId,GenreId,ArtistId,Title,Song,Price,AlbumArtUrl")] Album album)
        {
            if (id != album.AlbumId)
            {
                return NotFound();
